...
const Project = () => {
  return (
    <div className="w-full h-full flex justify-center animate-fade">
      <div className="mt-10 md:mt-14 w-full h-full max-w-[40rem] md:max-w-[70rem] flex flex-col items-center pt-10 after:content-[''] after:p-10">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 justify-items-center">
          ...
          <div className="w-4/5 mt-4 md:mt-0">
            <div className="w-full aspect-[3/2.4] relative">
              <Image src="/portfolio.png" fill alt="mine" />
            </div>
            <div className="py-3">
              <p className="text-xl font-semibold">&gt; 황서연의 포트폴리오</p>
              <p className="py-4">
                현재까지 진행해온 개발 프로젝트들을 정리해 나타낸 사이트입니다.
              </p>
              <h3 className="font-semibold">Skills</h3>
              <p className="text-sm ">NextJS, Typescript, TailwindCSS</p>
            </div>
          </div>
        </div>
      </div>
